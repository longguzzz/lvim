...
"  call Dfunc("RltvNmbr#RltvNmbrCtrl(start=".a:start.")")
  ...
  if      a:start && !exists("s:rltvnmbr_{bufnr('%')}")
   ...
   if !exists("s:rltvnmbr_signs")
	...
	hi default HL_RltvNmbr_Minus	gui=none,italic ctermfg=red   ctermbg=black guifg=#4d86b7   guibg=#16161e
	hi default HL_RltvNmbr_Positive	gui=none,italic ctermfg=green ctermbg=black guifg=#4d86b7 guibg=#16161e
...
"  call Dfunc("s:ColorschemeLoaded()")
	hi HL_RltvNmbr_Minus	ctermfg=red   ctermbg=black guifg=#4d86b7   guibg=#16161e
	hi HL_RltvNmbr_Positive	ctermfg=green ctermbg=black guifg=#4d86b7 guibg=#16161e
